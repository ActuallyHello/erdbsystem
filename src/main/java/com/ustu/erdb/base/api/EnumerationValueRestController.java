...
public class EnumerationValueRestController {
    ...
    public ResponseEntity<List<EnumerationValue>> getByEnumerationCode(@PathVariable String enumerationCode) {
        ...
        List<EnumerationValue> enumerationValues = enumerationValueService.getByEnumeration(enumeration);
        return ResponseEntity.ok(enumerationValues);
    }
}
